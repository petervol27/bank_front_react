      ...
      <div className="container my-5">
        ...
        <div className="section mb-5">
          ...
          <p className="text-muted">
            ...
            you in control and ahead financially. We are dedicated to delivering
            secure and efficient services, backed by the latest in financial
            technology, so you can focus on what matters most.
          </p>
        </div>
        ...
        <div className="section mb-5">
          ...
          <ul className="list-unstyled text-muted">
            ...
            <li>
              ...
              efficient, seamless, and innovative financial solutions is at the
              heart of Neo Banking.
            </li>
            <li>
              <strong>Transparency and Integrity</strong>: We believe in open
              communication and ethical practices, ensuring that our customers’
              trust is always upheld.
            </li>
          </ul>
        </div>
        ...
        <div className="section mb-5">
          ...
          <ul className="list-unstyled text-muted about-list">
            ...
            <li>
              <strong>Loans</strong>: From personal loans to business financing,
              we offer flexible options tailored to meet your unique
              requirements.
            </li>
            <li>
              <strong>Credit Cards</strong>: Choose from a variety of credit
              card options designed to suit different spending styles and reward
              preferences.
            </li>
            <li>
              <strong>Financial Services</strong>: Plan for the future with Neo
              Banking's expert financial guidance, investment opportunities, and
